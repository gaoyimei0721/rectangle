...
describe('isLegalKey() 测试', function() {  
  ...
  describe('合法字符：e', function() {
    it('允许出现在非科学计数法的合法数字末尾', function() {             expect(isLegalKey('e', '3', 1)).to.be.ok;          
    });

    it('允许出现在非科学计数法的合法数字中间', function() {            expect(isLegalKey('e', '3.141', 3)).to.be.ok;  
    });

    it('不允许出现在非科学计数法的合法数字前', function() {             expect(isLegalKey('e', '3.141', 0)).not.to.be.ok;     
    });
  ...
  describe('合法字符：E', function() {
    it('允许出现在非科学计数法的合法数字末尾', function() {            expect(isLegalKey('E', '3.141', 5)).to.be.ok;       
    });
